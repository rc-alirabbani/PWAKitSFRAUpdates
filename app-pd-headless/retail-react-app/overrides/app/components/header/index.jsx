...
const SearchBar = (props) => {
    ...
    return (
        <Box {...styles.searchContainer} className="rc-header-search">
...
/**
 * Header with Royal Cyber logo — search uses HideOnMobile/HideOnDesktop (not display:contents)
 * so the search icon stays correctly aligned in the InputGroup.
 */
const Header = ({
    children,
    onMenuClick = noop,
    ...
    return (
        <Box as="header" role="banner" {...styles.container} {...props}>
            <Box {...styles.content} position="relative">
